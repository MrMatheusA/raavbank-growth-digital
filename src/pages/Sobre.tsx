        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-up" style={{ animationDelay: '0.2s' }}>
              Sua confiança, nossa prioridade. Somos uma fintech especializada em soluções financeiras para empresas, produtores e pessoas físicas, oferecendo segurança, inovação e atendimento personalizado.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-8 text-center hover:shadow-hero transition-all duration-500 hover:-translate-y-2 group bg-gradient-to-br from-card to-secondary/30 border-0 shadow-lg">
                ...
                <p className="text-muted-foreground group-hover:text-foreground/80 transition-colors">
                  Simplificar a gestão financeira através de tecnologia segura e soluções inovadoras para empresas, produtores e pessoas físicas.
                </p>
              </Card>
              ...
              <Card className="p-8 text-center hover:shadow-hero transition-all duration-500 hover:-translate-y-2 group bg-gradient-to-br from-card to-secondary/30 border-0 shadow-lg" style={{ animationDelay: '0.1s' }}>
                ...
                <p className="text-muted-foreground group-hover:text-foreground/80 transition-colors">
                  Ser a principal referência em soluções financeiras digitais, conectando pessoas e empresas ao futuro dos pagamentos.
                </p>
              </Card>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Suporte especializado para pessoas físicas, empresas e produtores"
                },
                {
                  icon: CheckCircle,
